...
class PerformanceBenchmark:
    ...
    # --- REMOVED export_results function ---
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Wikipedia Embeddings Performance Benchmark")
    parser.add_argument(
        '--run_id', 
        type=int, 
        required=True, 
    ...
    db_logger.log_benchmark_results(args.run_id, benchmark.results)
