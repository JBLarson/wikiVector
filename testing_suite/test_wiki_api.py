...
# ============================================================================
# SPECIALIZED TESTS (Restored from previous version)
# ============================================================================
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Wikipedia Embeddings API Test Suite")
    parser.add_argument(
        '--run_id', 
        type=int, 
        required=True, 
    ...
    try:
        response = requests.get(f"{API_BASE}/api/related/test", timeout=TIMEOUT)
        ...
        print("Server is running but very slow. Check server logs.")
        sys.exit(1)
    ...
    print("Logging main test suite results to database...")
    db_logger.log_api_test_results(args.run_id, tester.results)
